...
> **Status**: v3.6.0 Ontology Theme Pilot is closed. v3.6.1 Phase 1A+1B are complete.
...
Status   Phase 1A+1B complete; next is Phase 1C bridge files + Opus mini-review
```
