...
- **v3.6.x — v3.7.x (NEXT)** — Remaining component rows + Wave 3 + pilot feedback iteration. Primary next candidates: remaining TODO components or BACKLOG #21 Interpreter Plugin strategy. Other candidates: BACKLOG #41 shared WordPress ripple runtime packaging decision, remaining BACKLOG #44 specimen coverage follow-ons, BACKLOG #46 disabled ripple host hygiene, BACKLOG #47 popover provider menu-item-class logic extraction hygiene, Sheet drag-to-dismiss follow-on, or a VS Code diagnostics sweep after component modularization.
