...
- **v3.6.x — v3.7.x (NEXT)** — Wave 2 (14 entries) + Wave 3 (3 entries) + pilot feedback iteration. Primary next candidates: BACKLOG #44 specimen follow-on coverage/editor compatibility, Wave 2 plan-first, BACKLOG #21 Interpreter Plugin strategy, or BACKLOG #41 shared WordPress ripple runtime packaging decision. Wave 2 likely splits into 2A (Navigation: App bar/Nav rail/Nav bar/Tabs/Menu) + 2B (Form: Checkbox/Radio/Switch + Dialog/Sheet + remaining Actions).
