...
- **v3.6.x — v3.7.x (NEXT)** — Wave 2 remainder + Wave 3 + pilot feedback iteration. Primary next candidate: Wave 2A-2 Menu plan-first. Other candidates: Wave 2B Form, BACKLOG #21 Interpreter Plugin strategy, BACKLOG #41 shared WordPress ripple runtime packaging decision, remaining BACKLOG #44 specimen coverage follow-ons, or BACKLOG #46 disabled ripple host hygiene.
