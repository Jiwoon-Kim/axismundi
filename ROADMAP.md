...
- **v3.6.x — v3.7.x (NEXT)** — Wave 2 (14 entries) + Wave 3 (3 entries) + pilot feedback iteration. Primary next candidates: Wave 2 plan-first or BACKLOG #21 Interpreter Plugin strategy. Alternative candidates: BACKLOG #41 shared WordPress ripple runtime packaging decision or remaining BACKLOG #44 specimen coverage follow-ons. Wave 2 likely splits into 2A (Navigation: App bar/Nav rail/Nav bar/Tabs/Menu) + 2B (Form: Checkbox/Radio/Switch + Dialog/Sheet + remaining Actions).
