---
source_url: https://developer.wordpress.org/block-editor/how-to-guides/enqueueing-assets-in-the-editor/
synced: 2026-05-12
handbook: block-editor
chapter: how-to-guides
slug: enqueueing-assets-in-editor
parent_order: 2
page_order: 6
...
As of WordPress 6.3, the Post Editor is iframed if all registered blocks have a [`Block API version 3`](../03-reference-guides/01-block-api-reference/metadata-in-block-json.md) or higher and no traditional metaboxes are registered. The Site Editor has always been iframed. This guide assumes you are looking to enqueue assets for the iframed Editor, but refer to the backward compatibility section below for additional considerations.
