---
source_url: https://developer.wordpress.org/block-editor/how-to-guides/format-api/
synced: 2026-05-12
handbook: block-editor
chapter: how-to-guides
slug: formatting-toolbar-api
parent_order: 2
page_order: 8
...
This guide assumes you are already familiar with WordPress plugins and loading JavaScript with them, see the [Plugin Handbook](../../plugin-handbook/00-plugin-handbook/index.md) or [JavaScript Tutorial](../01-getting-started/02-fundamentals-of-block-development/javascript-in-the-block-editor.md) to brush up.
...
By default, the button is rendered on every rich text toolbar (image captions, buttons, paragraphs, etc). You can render the button only on blocks of a certain type by using [the data API](../03-reference-guides/09-package-reference/packages/data.md).
