---
source_url: https://developer.wordpress.org/block-editor/how-to-guides/propagating-updates/
synced: 2026-05-12
handbook: block-editor
chapter: how-to-guides
slug: propagating-updates-for-block-types
parent_order: 2
page_order: 13
...
```html
<!-- wp:group {"className":"themeslug-special"} --><div class="wp-block-group themeslug-special"> <!-- Nested pattern blocks --></div><!-- /wp:group -->
```
...
- [Block deprecation](../03-reference-guides/01-block-api-reference/deprecation.md)
- [Create Block tool](../03-reference-guides/09-package-reference/packages/create-block.md)
