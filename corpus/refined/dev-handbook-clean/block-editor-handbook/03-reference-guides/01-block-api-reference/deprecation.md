...
- `attributes` (Object): The [attributes definition](attributes.md) of the deprecated form of the block.
- `supports` (Object): The [supports definition](registration.md) of the deprecated form of the block.
- `save` (Function): The [save implementation](edit-and-save.md) of the deprecated form of the block.
