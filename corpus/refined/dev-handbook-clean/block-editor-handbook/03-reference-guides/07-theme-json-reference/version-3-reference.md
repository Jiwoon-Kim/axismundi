...
sub_chapter: theme-json-reference
slug: version-3-reference
parent_order: 3
sub_order: 7
page_order: 1
...
> – the [theme.json v1](https://developer.wordpress.org/block-editor/reference-guides/theme-json-reference/theme-json-v1/) specification,  
> – the [theme.json v2](https://developer.wordpress.org/block-editor/reference-guides/theme-json-reference/theme-json-v2/) specification, and  
> – the [reference to migrate from older theme.json versions](https://developer.wordpress.org/block-editor/reference-guides/theme-json-reference/theme-json-migrations/).

This reference guide lists the settings and style properties defined in the `theme.json` schema. See the [theme.json how to guide](../../02-how-to-guides/05-themes/global-settings-and-styles.md) for examples and guidance on how to use the `theme.json` file in your theme.
...
See [Developing with theme.json](../../02-how-to-guides/05-themes/global-settings-and-styles.md#developing-with-themejson) for how to use the JSON schema in your editor.
