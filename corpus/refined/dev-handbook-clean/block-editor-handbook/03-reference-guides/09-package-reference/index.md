---
source_url: https://developer.wordpress.org/block-editor/reference-guides/packages/
synced: 2026-05-12
...
For information on creating and managing packages in Gutenberg, see the [packages README](https://developer.wordpress.org/block-editor/packages/README.md). For details on the build system and package configuration, see the [@wordpress/build README](https://developer.wordpress.org/block-editor/packages/wp-build/README.md).
...
For complete guidelines, see the [package guidelines](https://developer.wordpress.org/block-editor/packages/README.md#package-guidelines) in the packages README.
...
```php
wp_enqueue_script( 'my-custom-block', plugins_url( $block_path, __FILE__ ), array( 'react', 'wp-blocks', 'wp-block-editor', 'wp-i18n' ));
```
