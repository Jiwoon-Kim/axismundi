---
source_url: https://developer.wordpress.org/block-editor/reference-guides/packages/packages-lazy-editor/
synced: 2026-05-12
...
```js
import { Editor } from '@wordpress/lazy-editor'; function App() { return <Editor postType="page" postId="123" />;}
```
...
```text
// Edit a post<Editor postType="post" postId="42" /> // Edit a page<Editor postType="page" postId="123" /> // Edit a template<Editor postType="wp_template" postId="index" /> // Edit a custom post type<Editor postType="product" postId="789" />
```
