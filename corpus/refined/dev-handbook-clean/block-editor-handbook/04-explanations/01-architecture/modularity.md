---
source_url: https://developer.wordpress.org/block-editor/explanations/architecture/modularity/
synced: 2026-05-12
...
The above [Why?](modularity.md#why) section should provide some context for how individual packages aim to satisfy specific requirements. That applies to these packages as well:
...
- [Package Reference](../../03-reference-guides/09-package-reference/index.md)
