---
source_url: https://developer.wordpress.org/block-editor/explanations/user-interface/block-design/
synced: 2026-05-12
handbook: block-editor
chapter: explanations
sub_chapter: user-interface
slug: block-design
parent_order: 4
sub_order: 2
page_order: 1
...
You can add a description by using the description attribute in the [registerBlockType function](../../03-reference-guides/01-block-api-reference/registration.md).
...
Check how your block looks with [dark backgrounds](../../02-how-to-guides/05-themes/theme-support.md#dark-backgrounds) in the editor.
