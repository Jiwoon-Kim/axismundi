---
source_url: https://developer.wordpress.org/apis/security/common-vulnerabilities/
synced: 2026-05-12
...
If your theme includes any HTML or HTTP-based form submissions, use a [nonce](nonces.md) to guarantee a user intends to perform an action.
