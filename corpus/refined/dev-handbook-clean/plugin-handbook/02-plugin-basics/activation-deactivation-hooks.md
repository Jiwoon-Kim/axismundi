---
source_url: https://developer.wordpress.org/plugins/plugin-basics/activation-deactivation-hooks/
synced: 2026-05-12
handbook: plugin
...
parent_order: 2
page_order: 2
title: "Activation / Deactivation Hooks"
...
The deactivation hook is sometimes confused with the [uninstall hook](uninstall-methods.md). The uninstall hook is best suited to **delete all data permanently** such as deleting plugin options and custom tables, etc.  
