---
source_url: https://developer.wordpress.org/plugins/plugin-basics/header-requirements/
synced: 2026-05-12
handbook: plugin
...
As described in [Getting Started](index.md#getting-started), the main PHP file should include header comment what tells WordPress that a file is a plugin and provides information about the plugin.
...
- **License:** The short name (slug) of the plugin’s license (e.g. GPLv2). More information about licensing can be found in the [WordPress.org guidelines](../18-wordpress-org-plugin-directory/detailed-plugin-guidelines.md#1-plugins-must-be-compatible-with-the-gnu-general-public-license).
...
- **Text Domain:** The [gettext](https://www.gnu.org/software/gettext/) text domain of the plugin. More information can be found in the [Text Domain](../17-internationalization/internationalize-your-plugin.md#text-domains) section of the [How to Internationalize your Plugin](../17-internationalization/internationalize-your-plugin.md) page.
- **Domain Path:** The domain path lets WordPress know where to find the translations. More information can be found in the [Domain Path](../17-internationalization/internationalize-your-plugin.md#domain-path) section of the [How to Internationalize your Plugin](../17-internationalization/internationalize-your-plugin.md) page.
