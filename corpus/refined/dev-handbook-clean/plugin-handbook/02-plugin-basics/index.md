---
source_url: https://developer.wordpress.org/plugins/plugin-basics/
synced: 2026-05-12
handbook: plugin
...
```text
wordpress $ cd wp-contentwp-content $ cd pluginsplugins $ mkdir plugin-nameplugins $ cd plugin-nameplugin-name $ vi plugin-name.php
```
