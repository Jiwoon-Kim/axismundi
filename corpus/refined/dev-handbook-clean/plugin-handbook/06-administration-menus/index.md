---
source_url: https://developer.wordpress.org/plugins/administration-menus/
synced: 2026-05-12
handbook: plugin
...
When deciding between [Top-level menus](top-level-menus.md) and [Sub-menus](sub-menus.md) think carefully about the needs of your plugin as well as the needs of your end users.
