---
source_url: https://developer.wordpress.org/plugins/administration-menus/sub-menus/
synced: 2026-05-12
handbook: plugin
...
The process of removing Sub-menus is exactly the same as [removing Top-level menus](top-level-menus.md#remove-a-top-level-menu).

## Submitting forms

The process of handling form submissions within Sub-menus is exactly the same as [Submitting forms within Top-Level Menus](top-level-menus.md#submitting-forms).
...
As always, do not forget to check whether the form is being submitted, do CSRF verification, [validation](../03-plugin-security/data-validation.md), and sanitization.
