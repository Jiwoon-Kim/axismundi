---
source_url: https://developer.wordpress.org/plugins/shortcodes/
synced: 2026-05-12
handbook: plugin
chapter: shortcodes
slug: index
...
- **Always return!**  
Shortcodes are essentially filters, so creating “[side effects](https://en.wikipedia.org/wiki/Side_effect_%28computer_science%29)” will lead to unexpected bugs.
...
See the complete example of using a [basic shortcode structure, taking care of self-closing and enclosing scenarios, shortcodes within shortcodes and securing output](shortcodes-with-parameters.md#complete-example).
