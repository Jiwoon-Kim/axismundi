---
source_url: https://developer.wordpress.org/plugins/settings/custom-settings-page/
synced: 2026-05-12
handbook: plugin
chapter: settings
...
Creating a custom settings page includes the combination of: [creating an administration menu](../06-administration-menus/index.md), [using Settings API](using-settings-api.md) and [Options API](options-api.md).
