...
After the first call to [add_role()](https://developer.wordpress.org/reference/functions/add_role/) , the Role and it’s Capabilities will be stored in the database!
...
To alter the capabilities list in bulk: remove the role using [remove_role()](https://developer.wordpress.org/reference/functions/remove_role/) and add it again using [add_role()](https://developer.wordpress.org/reference/functions/add_role/) with the new capabilities.
...
After the first call to [remove_role()](https://developer.wordpress.org/reference/functions/remove_role/) , the Role and it’s Capabilities will be removed from the database!
