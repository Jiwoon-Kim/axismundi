---
source_url: https://developer.wordpress.org/plugins/http-api/
synced: 2026-05-12
handbook: plugin
chapter: http-api
slug: index
...
Just the body can be retrieved using `wp_remote_retrieve_body()`. This function takes just one parameter, the response from any of the other [wp_remote_X](https://developer.wordpress.org/?s=wp_remote_&amp;post_type%5B%5D=wp-parser-function) functions where retrieve is not the next value.
