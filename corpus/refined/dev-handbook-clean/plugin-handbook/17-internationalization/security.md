---
source_url: https://developer.wordpress.org/plugins/internationalization/security/
synced: 2026-05-12
handbook: plugin
...
parent_order: 17
page_order: 2
title: "Internationalization Security"
...
```text
_e( 'Please <a href="https://login.wordpress.org/register"> register for a WordPress.org account</a>.', 'your-text-domain');
```
...
```php
printf( esc_html__( 'Please %1$s register for a WordPress.org account %2$s.', 'your-text-domain' ), '<a href="https://login.wordpress.org/register">', '</a>');
```
