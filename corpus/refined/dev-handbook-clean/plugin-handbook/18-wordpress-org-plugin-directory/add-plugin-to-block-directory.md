---
source_url: https://developer.wordpress.org/plugins/wordpress-org/add-your-plugin-to-the-block-directory/
synced: 2026-05-12
handbook: plugin
chapter: wordpress-org-plugin-directory
slug: add-plugin-to-block-directory
parent_order: 18
page_order: 1
title: "Add Your Plugin to the Block Directory"
---
...
Block Plugins are required to be much smaller and more minimalist than a regular WordPress plugin in order to be safely installed with a single click. That means as well as keeping to the regular [plugin guidelines](detailed-plugin-guidelines.md) you’ll also need to follow some additional rules. In particular, you should stick to mostly JavaScript code and keep PHP to the bare minimum; and not add any UI or other code outside of the Gutenberg editor.
