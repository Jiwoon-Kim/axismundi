---
source_url: https://developer.wordpress.org/plugins/wordpress-org/block-specific-plugin-guidelines/
synced: 2026-05-12
handbook: plugin
...
parent_order: 18
page_order: 3
title: "Block Specific Plugin Guidelines"
---

# Block Specific Plugin Guidelines

All Block Specific plugins must also comply with the [overall plugin guidelines](detailed-plugin-guidelines.md). These additional guidelines are unique to block specific plugins.
