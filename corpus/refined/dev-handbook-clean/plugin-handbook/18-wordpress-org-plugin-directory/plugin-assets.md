---
source_url: https://developer.wordpress.org/plugins/wordpress-org/plugin-assets/
synced: 2026-05-12
handbook: plugin
...
parent_order: 18
page_order: 7
title: "How Your Plugin Assets Work"
---
...
Screenshots can be localized [similar to banners](plugin-assets.md#banner-filenames), the following filenames would take priority over the above English names when the plugin is viewed in German:
...
```bash
svn propset svn:mime-type image/png *.pngsvn propset svn:mime-type image/jpeg *.jpg
```
