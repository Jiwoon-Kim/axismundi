---
source_url: https://developer.wordpress.org/plugins/wordpress-org/preventing-wordpress-from-updating-your-external-plugin/
synced: 2026-05-12
handbook: plugin
chapter: wordpress-org-plugin-directory
slug: preventing-external-plugin-updates
parent_order: 18
page_order: 11
title: "preventing-external-plugin-updates"
...
```text
/** * Plugin Name: My Cool Plugin * Plugin URI: https://example.com/my-plugin/ * Description: My Plugin does cool things. * Version: 1.0 * Author: the team * Author URI: https://example.com/ * Text Domain: my-plugin * License: GPLv2 * License URI: https://opensource.org/licenses/gpl-2.0.php */
```
