---
source_url: https://developer.wordpress.org/plugins/wordpress-org/previews-and-blueprints/
synced: 2026-05-12
handbook: plugin
...
```text
Your plugin does not yet have a blueprint file for user previews. If you'd like to enable previews, please follow these steps to create a blueprint. 1. Test your plugin in Playground.2. Fix any bugs in your plugin that prevent it from working in Playground.3. Download blueprint.json4. Commit your blueprint to svn.
```
