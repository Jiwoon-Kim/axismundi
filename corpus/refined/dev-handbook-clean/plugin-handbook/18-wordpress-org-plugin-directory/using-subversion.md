---
source_url: https://developer.wordpress.org/plugins/wordpress-org/how-to-use-subversion/
synced: 2026-05-12
handbook: plugin
chapter: wordpress-org-plugin-directory
slug: using-subversion
parent_order: 18
page_order: 18
...
- [How the readme.txt works](plugin-readmes.md)
- [How plugin assets (header images and icons) work](plugin-assets.md)
...
Subversion keeps track of all these changes so that you can go back and look at old versions or **revisions** later if you ever need to. In addition to remembering each individual revision, you can tell subversion to **tag** certain revisions of the repository for easy reference. Tags are great for [labeling different releases of your plugin](using-subversion.md#task-3) and are the only fully supported method of ensuring the correct versions are seen on WordPress.org and updated for users.
...
Remember, *capitalization matters* — if your username is JaneDoe, then you must use the capital J and D or else SVN will fail. You can see the specific capitalization of your name in your account settings: [https://profiles.wordpress.org/me/profile/edit/group/3/?screen=svn-password](https://profiles.wordpress.org/me/profile/edit/group/3/?screen=svn-password)
...
- Use `assets` for [screenshots, plugin headers, and plugin icons](plugin-assets.md).
...
See also: [How Your Plugin Assets Work](plugin-assets.md)
...
```bash
$ cd my-local-dirmy-local-dir/ $ svn add trunk/*> A trunk/my-plugin.php> A trunk/readme.txt
```
