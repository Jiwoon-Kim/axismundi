---
source_url: https://developer.wordpress.org/rest-api/key-concepts/
synced: 2026-05-12
handbook: rest-api
...
Well-defined schema also provides one layer of security within the API, as it enables us to validate and sanitize the requests being made to the API. The [Schema section](04-extending-the-rest-api/schema.md) explores this large topic further.
