---
source_url: https://developer.wordpress.org/rest-api/using-the-rest-api/client-libraries/
synced: 2026-05-12
handbook: rest-api
...
To perform authenticated requests from outside of the WordPress admin, themes, or plugins, a separate [authentication plugin](authentication.md#authentication-plugins) is required.
