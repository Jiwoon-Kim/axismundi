---
source_url: https://developer.wordpress.org/rest-api/glossary/
synced: 2026-05-12
handbook: rest-api
chapter: glossary
slug: glossary
...
WordPress itself provides a HTTP Client in the [`WP_HTTP` class](../plugin-handbook/13-http-api/index.md) and related functions (e.g. `wp_remote_get()`). This can be used to access one WordPress site from another.
