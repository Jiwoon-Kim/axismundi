---
source_url: https://developer.wordpress.org/themes/getting-started/reading-this-handbook/
synced: 2026-05-12
handbook: theme
chapter: getting-started
slug: reading-this-handbook
parent_order: 1
page_order: 3
title: "Reading This Handbook"
---
...
**Setting things up: **if this is your first time building a theme, or if you just want a refresher on the basics of theme development, your next stop should be the [Tools and Setup](tools-and-setup.md) page. This will help you set up your development environment and determine which tools you need to start off on the right foot.
...
**Understanding the basics: **once you have everything set up and running, move onto the [Core Concepts](../02-core-concepts/index.md) chapter. There, you will learn the foundational principles behind creating WordPress themes.
...
*Feeling pretty hardcore? *Jump over to the [Advanced Topics](../07-advanced-topics/index.md) chapter. 

*Can’t remember the naming format for a particular template? *Find it in the [Template Hierarchy](../04-templates/template-hierarchy.md) docs.

*Need to brush up on `theme.json`? *No problem. Check out the [Global Settings and Styles](../03-theme-json/index.md) documentation. 
...
```php
<?php// theme-slug-editor becomes:wp_enqueue_script( 'fabled-sunset-editor', ... ); // theme-slug-main becomes:wp_enqueue_style( 'fabled-sunset-main', ... );
```
...
```php
<?php// theme-slug becomes:esc_html_e( 'Hello, world!', 'fabled-sunset' );
```
...
```php
<?php// theme_slug_func() becomes:function fabled_sunset_func() { // ...}
```
...
```php
<?php// Theme_Slug_Class() becomes:class Fabled_Sunset_Class() { // ...}
```
