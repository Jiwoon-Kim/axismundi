---
source_url: https://developer.wordpress.org/themes/core-concepts/main-stylesheet/
synced: 2026-05-12
handbook: theme
...
As described in [Theme Structure](theme-structure.md), WordPress requires that all themes include a `style.css` file. Its most important function is to “register” the theme with WordPress through configuration data at the top of the file. Many themes also use it to serve CSS to the front-end (and even the editor).
...
```text
/** * Theme Name: Grand Sunrise * Template: fabled-sunset * ...other header fields */
```
...
You can [learn more about child themes](../07-advanced-topics/child-themes.md) in the Advanced Topics chapter.
...
With block themes, most or all of the design is ideally handled through the `theme.json` file, which you will learn about in the [Global Settings and Styles](global-settings-and-styles.md) documentation.

But there are times when you will want or need to add custom CSS. You can learn more about this in the [Including Assets](including-assets.md) documentation.
