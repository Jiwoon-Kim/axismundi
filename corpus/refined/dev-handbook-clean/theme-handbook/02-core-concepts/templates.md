---
source_url: https://developer.wordpress.org/themes/core-concepts/templates/
synced: 2026-05-12
handbook: theme
...
In this document, you will learn the basic terminology around templating in WordPress. Reading through this quick primer on the subject will provide you with some foundational knowledge moving forward. There is a dedicated [Templates](../04-templates/index.md) chapter that provides a full overview of working with templates.
...
If no specific template is found, it will fall back to the Index template: `index.html`. As you learned in [Theme Structure](theme-structure.md), this is the minimum required template for a block theme to function.

The [Templates](../04-templates/index.md) chapter covers the hierarchy in full detail. There, you will learn which templates are loaded for each page of a WordPress site.
...
This is not an exhaustive list. You will learn the ins and outs of every template file as you dive deeper into the [Templates](../04-templates/index.md) chapter. The goal for now is to give you a baseline understanding of what to expect.
...
You’ll learn more about how to register and create custom parts in the [Template Parts](../04-templates/template-parts.md) documentation.
