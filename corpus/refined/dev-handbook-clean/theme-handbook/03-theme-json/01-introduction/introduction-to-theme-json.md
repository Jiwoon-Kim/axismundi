---
source_url: https://developer.wordpress.org/themes/global-settings-and-styles/introduction-to-theme-json/
synced: 2026-05-12
handbook: theme
chapter: theme-json
sub_chapter: introduction
slug: introduction-to-theme-json
parent_order: 3
sub_order: 1
page_order: 1001
title: "Introduction to theme.json"
---
...
The API is currently at version `2`. You can always find the most up-to-date version via the [`theme.json` Living Reference](../../../block-editor-handbook/03-reference-guides/07-theme-json-reference/version-3-reference.md) document.
...
- [**Settings**](../02-settings/index.md)**:** Documentation for each of the standard and custom settings that you can configure via `theme.json`.
- [**Styles**](../03-styles/index.md)**:** Learn how to use the standard design system to apply styles through `theme.json`, which also integrate with the user interface.
- [**Custom Templates**](../04-custom-templates.md)**:** How to register custom post, page, and CPT (custom post type) templates for your theme.
- [**Template Parts**](../06-template-parts.md)**:** How to register custom template parts that can be reused across your theme.
- [**Patterns**](../05-patterns.md)**: **How to bundle patterns from the official patterns repository with your theme.
- [**Style Variations**](../07-style-variations.md)**:** Documentation on creating custom `theme.json` style variations, giving your users alternative designs to choose from.
