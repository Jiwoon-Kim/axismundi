---
source_url: https://developer.wordpress.org/themes/global-settings-and-styles/style-variations/
synced: 2026-05-12
handbook: theme
chapter: theme-json
...
```json
{ "version": 2, "title": "Latte", "settings": {}, "styles": {}}
```
...
If you are familiar with the concept of [child themes](../07-advanced-topics/child-themes.md), which are covered in the [Advanced Topics](../07-advanced-topics/index.md) documentation, you may be wondering what the differences between them and style variations are.
