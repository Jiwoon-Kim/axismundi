---
source_url: https://developer.wordpress.org/themes/features/block-variations/
synced: 2026-05-12
handbook: theme
chapter: features
...
The [Block Variations API](../../block-editor-handbook/03-reference-guides/01-block-api-reference/variations.md) is often pitched as a plugin developer API. In many cases, plugins are the best place for variations to live. But there are also use cases for theme creators.

Several WordPress features use the term “variations” in their name. This can be confusing at times. The biggest thing to note is that block variations are not the same thing as [global style variations](../03-theme-json/07-style-variations.md) and [block style variations](block-style-variations.md).
...
The answer is almost always the same as the answer to another question: *Can these changes be made through [`theme.json` styles](../03-theme-json/03-styles/index.md) or CSS?* If yes, you should almost always create a custom [block style](block-style-variations.md).
...
To learn more about block variations, read the [Block Variations API](../../block-editor-handbook/03-reference-guides/01-block-api-reference/variations.md) documentation in the Block Editor Handbook.
