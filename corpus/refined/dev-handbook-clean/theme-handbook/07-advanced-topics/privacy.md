---
source_url: https://developer.wordpress.org/themes/advanced-topics/privacy/
synced: 2026-05-12
handbook: theme
...
While it is generally unnecessary for most themes, you can add a custom [Privacy Policy template](../04-templates/template-hierarchy.md#privacy-policy-page-hierarchy) to customize the output of the page. This is an optional template:
