---
source_url: https://developer.wordpress.org/themes/advanced-topics/security/
synced: 2026-05-12
handbook: theme
...
Your primary source for learning about security in the [Security chapter](../../common-apis-handbook/16-security.md) in the Common APIs Handbook. This article should be considered a supplement to what you will learn there and is not an all-encompassing guide on security itself. 
...
To avoid XSS vulnerabilities, any output should be escaped. Since it’s the theme’s primary responsibility to output content, you should always [escape dynamic content](../../common-apis-handbook/16-security/sanitizing-data.md) with the proper function based on the data type.
...
```php
$allowed_html = array( 'a' => array( 'href' => array() ), 'br' => array(), 'em' => array(), 'strong' => array()); echo wp_kses( $custom_content, $allowed_html );
```
...
This is more common in plugins than themes. But if your theme includes any HTML or HTTP-based form submissions, use a [nonce](../../common-apis-handbook/16-security/nonces.md) to guarantee a user intends to perform an action:
...
- [Common APIs Handbook: Security](../../common-apis-handbook/16-security.md)
```text
- [Escaping Data](../../common-apis-handbook/16-security/escaping-data.md)
- [Sanitizing Data](../../common-apis-handbook/16-security/sanitizing-data.md)
- [Validating Data](../../common-apis-handbook/16-security/validating-data.md)
- [Nonces](../../common-apis-handbook/16-security/nonces.md)
```
