---
source_url: https://developer.wordpress.org/themes/advanced-topics/testing/
synced: 2026-05-12
handbook: theme
...
A local development environment provides a controlled space for developing and testing your theme without impacting your live site. Some of the available options are listed in the [Tools and Setup](../01-getting-started/tools-and-setup.md) documentation.
