 ...
 *
 * Phase 2.3 implements the immutable Activity ledger, social relation materialization,
 * local Follow controls, Core Post Create recording, and a read-only administrator log. It creates no public
...
const AXISMUNDI_ACTIVITIES_VERSION = '0.0.6';
