/** axismundi/feed-surface-templates editor registration (no build step). */
( function ( blocks, blockEditor, element ) {
	'use strict';
	var el = element.createElement;
	var useInnerBlocksProps = blockEditor.useInnerBlocksProps || blockEditor.__experimentalUseInnerBlocksProps;

	blocks.registerBlockType( 'axismundi/feed-surface-templates', {
		edit: function () {
			var blockProps = blockEditor.useBlockProps( { className: 'axismundi-feed-surface-templates' } );
