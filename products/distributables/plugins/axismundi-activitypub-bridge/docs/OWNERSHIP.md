...
> Status: **0.0.3 dormant transport compatibility contract.**
...
| Inbox HTTP | Nobody while dormant | POST returns 503 before signature lookup | Avoid silent discard and official remote-Actor cache writes. |
