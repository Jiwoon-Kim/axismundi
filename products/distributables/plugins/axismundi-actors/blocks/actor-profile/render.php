...
<article <?php echo $axismundi_actor_profile_wrapper; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Core-generated block wrapper attributes. ?>>
	<div class="ax-actor-profile__cover<?php echo '' !== $axismundi_actor_profile_header ? ' has-image' : ''; ?>">
		<?php if ( '' !== $axismundi_actor_profile_header ) : ?>
			<?php echo wp_kses( $axismundi_actor_profile_header, $axismundi_actor_allowed_image ); ?>
		<?php endif; ?>
	</div>
	<div class="ax-actor-profile__body">
		<header class="ax-actor-profile__head">
			<div class="ax-actor-profile__avatar-frame">
			...
			<div class="ax-actor-profile__identity">
				...
				<p class="ax-actor-profile__meta">
					<span class="ax-actor-profile__handle"><?php echo esc_html( $axismundi_actor_profile_handle ); ?></span>
