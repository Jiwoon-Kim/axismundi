...
* Phase 0 — docs and scaffold. Locks the identity model (a shared wp_ax_identities
  registry plus a wp_ax_actors profile), the four distinct identifiers, the
  immutable actor URI vs mutable profile alias, and the projection registry
  contract. No behaviour ships yet.
