...
try {
	$ax_rg_calendar = axismundi_cal_calendar_save( array( 'name' => 'Range calendar', 'slug' => 'audit-range', 'timezone' => 'Asia/Seoul', 'owner_actor_uri' => axismundi_cal_default_local_authority() ) );
