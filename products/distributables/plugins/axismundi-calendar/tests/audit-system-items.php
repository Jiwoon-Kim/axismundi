...
ax_si_assert( $ax_si_results, 'with controls to select drafts, unlinked entries, or invert the visible selection', str_contains( $ax_si_holiday_editor, 'Select drafts' ) && str_contains( $ax_si_holiday_editor, 'Select unlinked' ) && str_contains( $ax_si_holiday_editor, 'Invert selection' ) && str_contains( $ax_si_holiday_editor, 'data-draft=' ) && str_contains( $ax_si_holiday_editor, 'data-unlinked=' ) && str_contains( $ax_si_holiday_controls, 'selectDrafts: function' ) && str_contains( $ax_si_holiday_controls, 'selectUnlinked: function' ) && str_contains( $ax_si_holiday_controls, 'invert: function' ) );
ax_si_assert( $ax_si_results, 'and can save selected reviewed entries as their own principal holidays', str_contains( $ax_si_holiday_editor, 'Save selected as principal holidays' ) && str_contains( $ax_si_holiday_editor, 'value="principal_days"' ) );
