...
= 0.0.40 =
* Gives public Notes and author-visible private or draft Notes their canonical
  Object document links in the editor and list views.
* Redirects legacy public Note post URLs to their canonical Object document.
* Preserves the Group context on local Note document routes.
...
* Ships the current staging integration alongside the Actor feed and Object
  listing-projection updates.

= 0.0.37 =
* Delegates the Note document's block-template choice to Object Projections. A
  Note reply and a cached remote reply are the same kind of page, and deciding
  separately here is what let the two paths drift apart. Notes keep their own
  route and their own access rules.
...
= 0.0.26 =
* Validate a Note media-picker selection before it enters the editor save queue,
  reporting the specific attachment when it has no federatable rendition.
