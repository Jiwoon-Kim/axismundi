...
ax_actor_projection_assert( $ax_actor_projection_results, 'transport fields cannot override representation-owned follow collections', is_array( $finalized ) && axismundi_op_actor_followers_url( $actor ) === $finalized['followers'] && axismundi_op_actor_follow_collection_url( $actor, 'following' ) === $finalized['following'] && ! isset( $finalized['featured'] ) );
