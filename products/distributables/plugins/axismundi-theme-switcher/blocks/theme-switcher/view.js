/**
 * axismundi/theme-switcher — front-end Interactivity store.
 *
 * Clicking a mode button writes <html data-theme="…">, letting Axismundi's token
 * CSS respond immediately, and persists the choice to the axismundi_theme
 * cookie. The plugin head script applies the persisted value before paint; this
 * store handles user toggles and the live active state.
 *
