 ...
 * Description: A geo taxonomy archive (geotag / geo area): the tonal hero, a Query Map View of the current term, then the inherited query-loop feed beside the archive sidebar.
 * Categories: query
 * Inserter: no
 *
...
<!-- wp:axismundi/map {"source":"current","height":420,"showPopups":true,"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|500"}}}} /-->
...
<!-- wp:post-terms {"term":"geotag","className":"is-style-tags","style":{"spacing":{"margin":{"top":"var:preset|spacing|100"}}},"textColor":"on-surface-variant","fontSize":"label-small"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></article>
<!-- /wp:group -->
<!-- /wp:post-template -->
