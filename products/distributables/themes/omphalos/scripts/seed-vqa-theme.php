...
$nav_content = '<!-- wp:home-link {"label":"Home"} /-->'
	...
	.     '<!-- /wp:navigation-submenu -->'
	.     '<!-- wp:navigation-submenu {"label":"Audio","url":"#att-audio","kind":"custom"} -->'
	.       '<!-- wp:navigation-link {"label":"Audio (ogg)","url":"' . $u( 'attachment_id=7' ) . '","kind":"custom"} /-->'
	.     '<!-- /wp:navigation-submenu -->'
	.     '<!-- wp:navigation-submenu {"label":"Video","url":"#att-video","kind":"custom"} -->'
	.       '<!-- wp:navigation-link {"label":"Video (webm)","url":"' . $u( 'attachment_id=9' ) . '","kind":"custom"} /-->'
	.       '<!-- wp:navigation-link {"label":"Caption #10 (vtt)","url":"' . $u( 'attachment_id=10' ) . '","kind":"custom"} /-->'
	.       '<!-- wp:navigation-link {"label":"Caption #11 (vtt)","url":"' . $u( 'attachment_id=11' ) . '","kind":"custom"} /-->'
	.     '<!-- /wp:navigation-submenu -->'
	.   '<!-- /wp:navigation-submenu -->'
	. '<!-- /wp:navigation-submenu -->'
	. '<!-- wp:loginout /-->';
