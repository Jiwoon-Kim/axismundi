...
printf(
	...
	$axismundi_dialogs_b_act['interactive'] ? axismundi_dialogs_action_context() : '', // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wp_interactivity_data_wp_context() escapes.
