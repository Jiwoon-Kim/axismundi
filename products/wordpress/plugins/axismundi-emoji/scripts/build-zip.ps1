...
$excludeDirs = @('scripts', 'tests', 'docs', 'wporg-assets', 'node_modules', '.git', '.github')
...
# Compress-Archive emits Windows backslashes in ZIP entry names under PowerShell 7.
# WordPress expects portable forward-slash entry names, so write entries explicitly.
