 ...
 * Plugin URI:        https://github.com/Jiwoon-Kim/axismundi/tree/main/products/wordpress/plugins/axismundi-media-library
...
require_once __DIR__ . '/includes/folder-identity.php';
...
require_once __DIR__ . '/includes/rights.php';
